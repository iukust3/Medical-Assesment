...
@Database(entities = [QuestionModel::class, TemplateModel::class,FeedBackModel::class,PreliminaryInfoModel::class ,Facility::class ], version = 1,exportSchema = true)
abstract class MedicalDataBase : RoomDatabase() {
    ...
    companion object {
        ...
        @Volatile private var INSTANCE: MedicalDataBase? = null
